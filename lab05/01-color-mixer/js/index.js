...
/* black */    if (redElement.value === 'ON' && yellowElement.value === 'ON' && blueElement.value === 'ON') {
                      document.body.style.backgroundColor = 'black';
/* orange */   } else if (redElement.value === 'ON' && yellowElement.value === 'ON') {
                      document.body.style.backgroundColor = 'orange';
/* purple */   } else if (redElement.value === 'ON' && blueElement.value === 'ON') {
                      document.body.style.backgroundColor = 'purple';
/* green */    } else if (yellowElement.value === 'ON' && blueElement.value === 'ON') {
                      document.body.style.backgroundColor = 'green';
/* yellow*/    } else if (yellowElement.value === 'ON') {
                      document.body.style.backgroundColor = 'yellow';
/* red */      } else if (redElement.value === 'ON') {
                      document.body.style.backgroundColor = 'red';
/* blue */     } else if (blueElement.value === 'ON') {
