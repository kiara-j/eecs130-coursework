...
moveFish(fishList[8]);
moveFish(fishList[9]);
moveFish(fishList[10]);
moveFish(fishList[11]);
moveFish(fishList[12]);
moveFish(fishList[13]);
moveFish(fishList[14]);
moveFish(fishList[15]);
moveFish(fishList[16]);
moveFish(fishList[17]);
moveFish(fishList[18]);
moveFish(fishList[19]);
moveFish(fishList[20]);
} */
