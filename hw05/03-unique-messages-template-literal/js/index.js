...
document.write(people.name + "'s high score is: " + people.score + "<br>");
} */
...
template = `
    ...
    <div class="player-detail">
        <p>${people[2].name}'s high score is: ${people[2].score}</p>
    </div>
`;
document.querySelector(".players").innerHTML += template;
...
template = `
    ...
    <div class="player-detail">
        <p>${people[3].name}'s high score is: ${people[3].score}</p>
    </div>
`;
document.querySelector(".players").innerHTML += template;
...
template = `
    <div class="card">
        <img src="${people[4].pic}">
    </div>
    <div class="player-detail">
        <p>${people[4].name}'s high score is: ${people[4].score}</p>
    </div>
`;
document.querySelector(".players").innerHTML += template;
...
template = `
    ...
    <div class="player-detail">
        <p>${people[5].name}'s high score is: ${people[5].score}</p>
    </div>
`;
document.querySelector(".players").innerHTML += template;
...
template = `
    <div class="card">
        <img src="${people[6].pic}">
    </div>
    <div class="player-detail">
        <p>${people[6].name}'s high score is: ${people[6].score}</p>
    </div>
`;
document.querySelector(".players").innerHTML += template;
